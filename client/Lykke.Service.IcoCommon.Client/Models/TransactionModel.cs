...
namespace Lykke.Service.IcoCommon.Client.Models
{
    ...
    public partial class TransactionModel
    {
        ...
        /// 'USD'</param>
        public TransactionModel(System.DateTime createdUtc, CurrencyType currency, decimal amount, string blockId, string uniqueId, string transactionId, string payInAddress)
        {
            BlockId = blockId;
